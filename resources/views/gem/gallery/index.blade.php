...
<html>
<head>
<title>Gem Stone a Fashion Category Flat Bootstrap Responsive Website Template| Gallery :: w3layouts</title>
			 ...
			 <div class="header">
				  ...
				  <div class="top-nav">										 
					   ...
					   <ul class="nav">
						 ...
						 <li class="dropdown1"><a class="active" href="gallery.html">GALLERY</a>
							 <ul class="dropdown2">
